...
function arrange(opts){
  ...
  if (opts.drumPat) {
    ...
    for (let tt = 0; tt < D - 2; tt += step) {
      ...
      if (v > 0) note(L, R, tt, v >= 1 ? opts.root / 2 : opts.root / 2.14, v >= 1 ? 0.8 : 0.45, { type: 'drum', gain: v >= 1 ? 0.24 : 0.13, decay: v >= 1 ? 7 : 10, pan: (rng() - 0.5) * 0.3, rng });
      k++;
    }
  }
...
T('title',3,{seed:13,bpm:48,root:ROOT.A,minor:true,lead:'pluck',leadOct:2,melodyGain:0.27,accGain:0.06,padGain:0.08,bellEvery:2,breath:0.8});
...
T('town',5,{seed:25,bpm:72,root:ROOT.A,minor:true,lead:'flute',leadOct:2,melodyGain:0.18,accGain:0.09,accDiv:0.5,padGain:0.06,breath:0.3});
...
T('capital',5,{seed:35,bpm:50,root:ROOT.A,minor:true,lead:'pluck',leadOct:1,melodyGain:0.19,accGain:0.06,padGain:0.09,bellEvery:3,breath:0.8});
...
T('sect',2,{seed:42,bpm:44,root:ROOT.A,minor:true,lead:'bell',leadOct:2,melodyGain:0.13,accGain:0.04,padGain:0.10,bellEvery:0,breath:1.2});
...
T('hidden',1,{seed:51,bpm:54,root:ROOT.A,minor:true,lead:'flute',leadOct:2,melodyGain:0.17,accGain:0.04,padGain:0.09,bellEvery:3,breath:0.9,rainLevel:0.02});
...
T('hidden',4,{seed:54,bpm:52,root:ROOT.C,lead:'pluck',leadOct:2,melodyGain:0.22,accGain:0.04,padGain:0.09,bellEvery:2,breath:1.0,rainLevel:0.016});
T('hidden',5,{seed:55,bpm:48,root:ROOT.A,minor:true,lead:'bell',leadOct:2,melodyGain:0.11,accGain:0.04,padGain:0.10,bellEvery:0,breath:1.3});
...
// danger（6）：紧张但守拍
T('danger',1,{seed:61,bpm:92,root:ROOT.A,minor:true,lead:'pluck',leadOct:2,melodyGain:0.20,accGain:0.06,accDiv:0.5,padGain:0.07,drumPat:[1,0,0,0.5,0,0,0.6,0],breath:0.2});
T('danger',2,{seed:62,bpm:96,root:ROOT.E,minor:true,lead:'pluck',leadOct:2,melodyGain:0.19,accGain:0.06,accDiv:0.5,padGain:0.07,drumPat:[1,0,0.5,0,1,0,0.6,0.6],breath:0.15});
T('danger',3,{seed:63,bpm:88,root:ROOT.A,minor:true,lead:'flute',leadOct:1,melodyGain:0.14,accGain:0.06,accDiv:0.5,padGain:0.08,drumPat:[1,0,0,0,0.6,0,0.5,0],breath:0.3});
T('danger',4,{seed:64,bpm:94,root:ROOT.D,minor:true,lead:'pluck',leadOct:2,melodyGain:0.20,accGain:0.05,accDiv:1,padGain:0.07,drumPat:[1,0,0.6,0,0,0.5,0,0],breath:0.25});
T('danger',5,{seed:65,bpm:90,root:ROOT.E,minor:true,lead:'pluck',leadOct:2,melodyGain:0.18,accGain:0.06,accDiv:0.5,padGain:0.07,drumPat:[1,0,0,0.6,1,0,0.5,0],breath:0.2});
T('danger',6,{seed:66,bpm:84,root:ROOT.A,minor:true,lead:'flute',leadOct:1,melodyGain:0.13,accGain:0.05,accDiv:1,padGain:0.08,drumPat:[1,0,0,0,1,0,0,0],breath:0.4});
// battle（6）：激昂战鼓
T('battle',1,{seed:71,bpm:112,root:ROOT.D,minor:true,lead:'pluck',leadOct:2,melodyGain:0.22,accGain:0.07,accDiv:0.5,padGain:0.06,drumPat:[1,0,0.6,0.5,1,0,0.6,0],breath:0.1});
T('battle',2,{seed:72,bpm:120,root:ROOT.A,minor:true,lead:'pluck',leadOct:2,melodyGain:0.21,accGain:0.08,accDiv:0.5,padGain:0.05,drumPat:[1,0.5,0,0.6,1,0,0.6,0.6],breath:0.08});
T('battle',3,{seed:73,bpm:116,root:ROOT.D,minor:true,lead:'pluck',leadOct:2,melodyGain:0.22,accGain:0.07,accDiv:0.5,padGain:0.06,drumPat:[1,0,0,0.5,0,0.6,1,0],breath:0.1});
T('battle',4,{seed:74,bpm:108,root:ROOT.E,minor:true,lead:'pluck',leadOct:2,melodyGain:0.21,accGain:0.07,accDiv:0.5,padGain:0.06,drumPat:[1,0,0.6,0,1,0.5,0,0],breath:0.12});
T('battle',5,{seed:75,bpm:124,root:ROOT.A,minor:true,lead:'pluck',leadOct:2,melodyGain:0.20,accGain:0.08,accDiv:0.5,padGain:0.05,drumPat:[1,0.5,0.6,0.5,1,0,0.6,0.5],breath:0.08});
T('battle',6,{seed:76,bpm:112,root:ROOT.D,minor:true,lead:'flute',leadOct:1,melodyGain:0.15,accGain:0.07,accDiv:0.5,padGain:0.06,drumPat:[1,0,0.6,0,1,0,0.6,0.5],breath:0.15});
